      ...
      <div className="container">
        ...
        <div className="bottom">
          <div className="left">
           ...
           <a href="mailto:prolnancerhelpdesk@gmail.com?subject=Need Help" className="contact-link">Contact Us</a>
            <a href="mailto:prolnancerhelpdesk@gmail.com?subject=Feedback" className="contact-link">Feedback</a>
          </div>
          <div className="right">
